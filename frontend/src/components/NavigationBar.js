      ...
      <nav>
        ...
        <div>
          <ul id='navBar'>
            ...
            <li><a id='nav1' href='/canvas'>画板</a></li>
            <li><a id='nav2' href='/AIdraw'>智绘</a></li>
            <li><a id='nav3' href='/pixel'>像素</a></li>
            <li><a id='nav5' href='/account'>个人</a></li>
          </ul>
        </div>
      </nav>
    </>
